...
# price = UnitPrice.objects.filter(type__title='CB账号',level__name='2')
# for i in price:
#     print(i.price)
#     print(price.count())
...
# levels = type_obj.unitprice_set.all()
# for i in levels:
#     print(i.price)
#     print(i.level)
...
#     title = type.title
#     print('账号类型：',title)
#     # print(type.unitprice_set.all())
#     for i in type.unitprice_set.all():
#         print('价格：',i.price)
#         for j in i.account_set.all():
#             print('账号信息：',j.account_str)
...
# type = TypeInfo.objects.filter(pk=1).first()
# levels = LevelInfo.objects.all()
# level_list = []
# for i in levels:
#     level_list.append(i.name)
...
#
# for j in levels:
#     prices = UnitPrice.objects.select_related('type').filter(type__pk=5, level__name=j.name)
#     for i in prices:
#         level_dic = {}
#         level_dic.setdefault('level', j.name)
#         level_dic.setdefault('price', i.price)
#         level_dic.setdefault('count', i.account_set.count())
