...
class Account(models.Model):
    ...
    order = models.ForeignKey('ac_order.OrderInfo', related_name='account', on_delete=models.CASCADE, null=True,
                              blank=True)  # 订单编号
    ...
    def clean(self, exclude=None):
        self.allow_sale_time = datetime.datetime.now() + datetime.timedelta(hours=ALLOW_SALE_TIME)  # 修改允许出售时间
